    ...
    <>
      <footer id="footer" data-fullpage-section className="scroll-mt-14 relative overflow-hidden bg-gradient-to-b from-[#FFFFFF] via-[#F8F9FC] to-[#F1F3F9] py-12 text-xs text-slate-700 sm:py-16 sm:text-sm lg:flex lg:h-[100svh] lg:snap-start lg:snap-always lg:items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          {/* ── 1. Brand Wordmark (고대비 스위스 에디토리얼 워드마크) ── */}
          <div className="mb-6 sm:mb-8">
            <BrandLogo onClick={scrollToTop} variant="light" />
          </div>
          ...
          <div className="space-y-2 text-xs sm:text-sm text-slate-600 font-medium leading-relaxed max-w-4xl mb-8">
            <div className="flex flex-wrap items-baseline gap-x-6 gap-y-1">
              <div className="flex items-center space-x-2">
                <span className="text-slate-500 font-bold">주소</span>
                <span className="text-slate-900">서울특별시 강남구 논현동 114-14 금산빌딩 4층</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-slate-500 font-bold">대표</span>
                <span className="text-slate-900">박상희</span>
              </div>
            </div>

            <div className="flex flex-wrap items-baseline gap-x-6 gap-y-1">
              <div className="flex items-center space-x-2">
                <span className="text-slate-500 font-bold">사업자등록번호</span>
                <span className="text-slate-900 font-semibold">211-86-77077</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-slate-500 font-bold">Tel</span>
                <span className="text-slate-900 font-semibold">02-3446-7668</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-slate-500 font-bold">Fax</span>
                <span className="text-slate-900 font-semibold">02-3446-6388</span>
              </div>
            </div>

            <div className="flex flex-wrap items-baseline gap-x-6 gap-y-1">
              <div className="flex items-center space-x-2">
                <span className="text-slate-500 font-bold">통신판매업</span>
                <span className="text-slate-900">통신판매업 신고번호 강남 2240호</span>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-slate-200 flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
            ...
            <div className="flex items-center space-x-4 self-end md:self-auto">
              ...
              <button
                type="button"
                onClick={scrollToTop}
                className="px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-lg border border-slate-300 bg-white hover:bg-slate-50 active:bg-slate-100 text-slate-800 font-bold text-xs sm:text-sm shadow-sm transition-all cursor-pointer flex items-center space-x-1 min-h-[38px]"
